...
import com.saucedemo.pages.CreateRepoPOJO;
...
public class CreateRepoTest {
	...
	String endPoint = createURL.getBaseURI("/users/2");
...
//		RestFWLogger.endTestCase();
	...
	public void deleteRepo() throws IOException {
		...
		String deleteEndPoint = createURL.getBaseURI("/users/2") + CommonUtilFunctions.getResponseKeyValue(req_Payload, "name");
	...
	public void deleteRepoPOJO() throws IOException {
		...
		String deleteEndPoint = createURL.getBaseURI("/users/2") + requestPayload.getName();
